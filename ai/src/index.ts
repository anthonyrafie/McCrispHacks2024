...
export default {
	async fetch(request: Request, env: Env) {
	  ...
	  const output_format = `Name: <name of the business idea/startup> e.g. "GreenTech Ventures"
	  ...
	  const response = await ai.run('@cf/meta/llama-2-7b-chat-int8', {
		  prompt: "Analyze the following business meeting transcript and evaluate if it is a good investment opportunity: " + transcript + "Give your response in the following format: " + output_format
		}
	  );
